...
<p align="center">
	...
	<a href="https://pkg.go.dev/github.com/maxence-charriere/go-app/v9/app"><img src="https://img.shields.io/badge/dev-reference-007d9c?logo=go&logoColor=white&style=flat" alt="pkg.go.dev docs"></a>
...
It **uses [Go HTTP standard](https://golang.org/net/http) model**.
...
Apps created with go-app complies with [Go standard HTTP](https://golang.org/net/http) package interfaces.
